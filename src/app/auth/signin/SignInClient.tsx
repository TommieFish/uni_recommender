...
export function SignInClient()
{
  ...
  {
    toast.error("Login failed", {description: "Error logging in with Google. Try again.",});
    console.error("Error logging in with Google. Error:", error);
  ...
  return (
    ...
    >
      ...
      <span className="ml-2 hover:bg-blue-200">Login with Google</span>
    </Button>
  );
}
